...
# 2. Fork한 저장소에서 작업
git clone https://github.com/{contributor}/alhangeul-tauri.git
git checkout -b feature/my-task
# ... 작업 + 커밋 ...
git push origin feature/my-task

# 3. 원본 저장소의 devel로 PR 생성
gh pr create --repo postmelee/alhangeul-tauri --base devel --head {contributor}:feature/my-task --title "제목"
