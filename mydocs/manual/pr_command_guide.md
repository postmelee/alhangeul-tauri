...
```text
https://github.com/postmelee/alhangeul-tauri/blob/{sha}/mydocs/...
```
...
```md
- 수행 계획서: [task_m010_61.md](https://github.com/postmelee/alhangeul-tauri/blob/{sha}/mydocs/plans/task_m010_61.md)
- 구현 계획서: [task_m010_61_impl.md](https://github.com/postmelee/alhangeul-tauri/blob/{sha}/mydocs/plans/task_m010_61_impl.md)
- 최종 보고서: [task_m010_61_report.md](https://github.com/postmelee/alhangeul-tauri/blob/{sha}/mydocs/report/task_m010_61_report.md)
```

Stage별 요약에서는 Stage 제목을 단계 보고서로 링크하고, 옆의 짧은 commit SHA를 commit URL로 링크한다. 예시는 다음과 같다.

```md
- **[Stage 1](https://github.com/postmelee/alhangeul-tauri/blob/{sha}/mydocs/working/task_m010_61_stage1.md)** ([abc1234](https://github.com/postmelee/alhangeul-tauri/commit/{stage1_sha})): {Stage 1 한 줄 요약}
```
