...
| 지표 | 변경 전 | 변경 후 |
|---|---:|---:|
| upstream sync workflow | 없음 | 1개, 292 LOC |
| release·reference·PR body helper | 없음 | 3개, 합계 628 LOC |
| 전용 contract test | 없음 | 4개, 합계 775 LOC |
| 전체 `test:automation` | 71 tests | 104 tests |
...
| automation·upstream·Studio 회귀 | OK — 104 + 35 + 97 tests 통과 |
